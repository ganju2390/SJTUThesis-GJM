...
\sjtusetup{
  ...
  info = {%
    ...
    % 标题
    %
    zh / title           = {ROV控制系统模块设计与综合试验研究},
    en / title           = {Design and Comprehensive Test of Control System Modules for ROV},
    %
    % 标题页标题
    %   可使用“\\”命令手动控制换行
    %
    ...
    %
    zh / subject         = {机械工程},
    zh / keywords        = {遥控水下机器人, 运动控制, SQRT-PID, 扩展状态观测器, 嵌入式系统, 推力分配},
    en / keywords        = {remotely operated vehicle, motion control, SQRT-PID, extended state observer, embedded system, thrust allocation},
    %
    % 姓名
    %
    zh / author          = {郭佳铭},
    en / author          = {Jiaming Guo},
    %
    % 学号
    %
    id              = {522021910197},
    ...
    en / department      = {School of Mechanical Engineering},
    %
    % 专业
    %
    zh / major           = {机械工程},
    ...
    %   覆盖对应标题页的日期显示，原样输出
    %
    zh / display-date    = {2026 年 5 月 17 日},
    %
    % 资助基金
    %
    % zh / fund  = {
