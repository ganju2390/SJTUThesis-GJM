...
\sjtusetup{
  ...
  info = {%
    ...
    zh / keywords        = {ROV, 控制系统, 模块设计, 综合试验},
    en / keywords        = {ROV, control system, module design, comprehensive test},
    %
    % 姓名
    %
    zh / author          = {郭佳铭},
    ...
    %
    zh / supervisor      = {张亚欧},
    en / supervisor      = {Prof.\ Yaoou Zhang},
    %
    % 副指导教师
    %
    ...
    %   覆盖对应标题页的日期显示，原样输出
    %
    zh / display-date    = {2026 年 5 月 xx 日},
    %
    % 资助基金
    %
    % zh / fund  = {
