...
\sjtusetup{
  ...
  info = {%
    ...
    %
    % zh / subject         = {机械工程},
    zh / keywords        = {遥控水下机器人, 运动控制, 扩展状态观测器, 嵌入式系统, 推力分配},
    en / keywords        = {Remotely operated vehicle, Motion control, Extended state observer, Embedded system, Thrust allocation},
    %
    % 姓名
    %
    zh / author          = {郭佳铭},
